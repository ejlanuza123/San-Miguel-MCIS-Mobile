...
const ProfileIcon = () => (
  <Svg width="100%" height="100%" viewBox="0 0 24 24" fill="#d1d5db">
...
const Step1 = ({
  ...
  <>
    ...
    <TextInput
      ...
      onChangeText={(t) => handleChange("blood_type", t)}
    />
    <TextInput
      style={styles.input}
    ...
    <TextInput
      ...
      onChangeText={(t) => handleChange("nhts_no", t)}
    />
    <TextInput
      style={styles.input}
      ...
      onChangeText={(t) => handleChange("philhealth_no", t)}
    />
    ...
    <View style={styles.grid}>
      <TextInput
        ...
        onChangeText={(t) => handleChange("g_score", t)}
      ...
      <TextInput
        ...
        onChangeText={(t) => handleChange("p_score", t)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.gridInput}
        ...
        placeholderTextColor="#9ca3af"
        value={formData.term}
        onChangeText={(t) => handleChange("term", t)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.gridInput}
        ...
        onChangeText={(t) => handleChange("preterm", t)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.gridInput}
        ...
        onChangeText={(t) => handleChange("abortion", t)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.gridInput}
        ...
        onChangeText={(t) => handleChange("living_children", t)}
        keyboardType="numeric"
      />
    </View>
  </>
...
const Step2 = ({
  ...
  <>
    ...
    <TextInput
      style={styles.input}
      placeholder="Age of First Period"
      placeholderTextColor="#9ca3af"
      value={formData.age_first_period}
      onChangeText={(t) => handleChange("age_first_period", t)}
      keyboardType="numeric"
    />
    ...
    <TextInput
      ...
      onChangeText={(t) => handleChange("age_of_menarche", t)}
      keyboardType="numeric"
    />
    <TextInput
      style={styles.input}
      placeholder="Amount of Bleeding (Scanty/Moderate/Heavy)"
      placeholderTextColor="#9ca3af"
      value={formData.bleeding_amount}
      onChangeText={(t) => handleChange("bleeding_amount", t)}
    />
    <TextInput
      style={styles.input}
      placeholder="Duration of Menstruation (days)"
      placeholderTextColor="#9ca3af"
      value={formData.menstruation_duration}
      onChangeText={(t) => handleChange("menstruation_duration", t)}
      keyboardType="numeric"
    />
...
const Step3 = ({ formData, handleChange }) => (
  <>
    ...
    <View style={styles.checkboxGrid}>
      {["Diabetes Mellitus", "Asthma", "CVD", "Heart Disease", "Goiter"].map(
        (item) => (
          <Checkbox
            key={item}
            label={item}
            value={!!formData[`ph_${item}`]}
            onValueChange={(v) => handleChange(`ph_${item}`, v)}
          />
        )
      )}
    </View>
    ...
    <View style={styles.checkboxGrid}>
      {[
        ...
        <Checkbox
          key={item}
          label={item}
          value={!!formData[`hdh_${item}`]}
          onValueChange={(v) => handleChange(`hdh_${item}`, v)}
        />
      ))}
    </View>
    <Text style={styles.subSectionTitle}>Social History</Text>
    <View style={styles.checkboxGrid}>
      {["Smoker", "Ex-smoker", "Alcohol Drinker", "Substance Abuse"].map(
        (item) => (
          <Checkbox
            key={item}
            label={item}
            value={!!formData[`sh_${item}`]}
            onValueChange={(v) => handleChange(`sh_${item}`, v)}
          />
        )
      )}
    </View>
...
const Step4 = ({ formData, handleChange }) => (
  <>
    ...
    <View style={styles.grid}>
      {["TT1", "TT2", "TT3", "TT4", "TT5"].map((vaccine) => (
        <TextInput
          ...
          value={formData[`vaccine_${vaccine}`] || ""}
          onChangeText={(t) => handleChange(`vaccine_${vaccine}`, t)}
        />
      ))}
    </View>
    ...
    <TextInput
      ...
      placeholder="History of Allergy and Drugs..."
      placeholderTextColor="#9ca3af"
      multiline
      value={formData.allergy_history}
      onChangeText={(t) => handleChange("allergy_history", t)}
    />
    <TextInput
      style={styles.textArea}
      placeholder="Family Planning History..."
      placeholderTextColor="#9ca3af"
      multiline
      value={formData.family_planning_history}
      onChangeText={(t) => handleChange("family_planning_history", t)}
    />
  </>
);
...
export default function AddPatientModal({
  ...
  useEffect(() => {
    if (mode === "edit" && initialData) {
      setFormData(
        typeof initialData.medical_history === "string"
          ? JSON.parse(initialData.medical_history)
        ...
        if (netInfo.isConnected) {
          ...
          if (error) {
            ...
            const localPatients = await db.getAllAsync(
              'SELECT * FROM patients WHERE patient_id LIKE "P-%"'
            );
            const newId = `P-${String((localPatients.length || 0) + 1).padStart(
              3,
              "0"
            )}`;
            setPatientId(newId);
          ...
          // OFFLINE: ALWAYS use a unique temporary ID
          const uniqueId = `TEMP-${Crypto.randomUUID()}`; // Generate a guaranteed unique ID
          setPatientId(uniqueId);
          console.log("Offline: Generated temporary patient ID:", uniqueId);
        }
      };
      generateId();
    }
        ...
        >
          <View style={styles.profileSection}>
            <View style={styles.avatarPlaceholder}>
              {patientId ? (
                <QRCode value={patientId} size={80} backgroundColor="#f3f4f6" />
              ) : (
                <ProfileIcon />
              )}
            </View>
