...
export default function BnsInventoryScreen() {
    ...
    useCallback(() => {
      ...
      const options = [
        ...
        { label: "Medicines", onPress: () => setActiveFilter("Medicines") },
        {
          ...
          onPress: () => setActiveFilter("Nutrition & Feeding"),
        },
        {
          label: "Medical Supplies",
          onPress: () => setActiveFilter("Medical Supplies"),
        },
        { label: "Vaccines", onPress: () => setActiveFilter("Vaccines") },
        { label: "Equipment", onPress: () => setActiveFilter("Equipment") },
        {
          label: "Child Hygiene & Care",
          onPress: () => setActiveFilter("Child Hygiene & Care"),
        },
      ].map((opt) => ({
        ...opt,
        onPress: () => {
  ...
  return (
    <>
      ...
      <Modal visible={isViewModalOpen} animationType="fade" transparent={true}>
        <ViewBnsInventoryModal
          item={selectedItem}
